        ...
        <div class="d-flex flex-column flex-row-fluid">
            ...
            <div class="page-title d-flex align-items-center me-3">
                ...
                <h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-lg-2x gap-2">
                    <span>Tickets Finalizados / Resueltos</span>
                </h1>
                <!--end::Title-->
            </div>
            <!--end::Page title-->
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold mb-3 fs-7">
                ...
                <li class="breadcrumb-item text-gray-700">
                    Listado completo de Tickets resueltos
                </li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_custom_ticket_table">
                <thead>
                    <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-100px">Finalizado</th>
                    </tr>
                </thead>
            </table>
            <!--end::Table-->
...
<script src="<?= base_url('assets/js/custom/cliente/tickets.finalizados.js') ?>"></script>
