        ...
        <div class="d-flex flex-column flex-row-fluid">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold mb-3 fs-7">
                ...
                <li class="breadcrumb-item text-gray-700">
                    Listado completo de Tickets por aprobar
                </li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_custom_ticket_table">
                <thead>
                    <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-100px">Cerrado</th>
                        <th class="min-w-80px">Opciones</th>
                    </tr>
                </thead>
            </table>
            <!--end::Table-->
...
<script src="<?= base_url('assets/js/custom/cliente/tickets.por.aprobar.js') ?>"></script>
