...
<!--begin::Head-->
    ...
    <body  id="kt_body"  class="app-blank bgi-size-cover bgi-attachment-fixed bgi-position-center bgi-no-repeat" >
        ...
        <div class="d-flex flex-column flex-root" id="kt_app_root">
            ...
            <style>
                body {
                    background-image: url('<?= base_url('assets/images/bg/bg-login.jpg') ?>');
                }

                [data-bs-theme="dark"] body {
                    background-image: url('<?= base_url('assets/images/bg/bg-login-dark.jpg') ?>');
                }
            </style>
            <!--end::Page bg image-->
            ...
            <div class="d-flex flex-column flex-column-fluid flex-lg-row">
                ...
                <div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">              
                    ...
                    <div class="d-flex flex-center flex-lg-start flex-column w-100">              
                        ...
                        <!--begin::Title-->
                        <div><span class="fs-2 text-white fw-normal m-0" id="letreroHelpDesk"></span></div>
                        <!--end::Title-->         
                    </div>
                    <!--begin::Aside-->    
                </div>
                ...
                <div class="d-flex flex-column-fluid flex-lg-row-auto justify-content-center justify-content-lg-end p-12 p-lg-20">
                    ...
                    <div class="bg-body d-flex flex-column align-items-stretch flex-center rounded-4 w-md-600px p-20">
                        ...
                        <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10">
                            <!--begin::Form-->
                            <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="<?= base_url('cliente') ?>" action="#">
                                <!--begin::Heading-->
                                <div class="text-center mb-11">
                                    ...
                                    <div class="text-gray-500 fw-semibold fs-6">
                                        Inicie sesión en su cuenta de TicketPedia
                                    </div>
                                    <!--end::Subtitle--->
                                </div>
                                <!--begin::Heading-->
                                ...
                                <div class="fv-row mb-8">
                                    <!--begin::usuario_nombre-->
                                    <input type="text" placeholder="Nombre de usuario" name="usuario_nombre" id="usuario_nombre" autocomplete="off" class="form-control bg-transparent"/> 
                                    <!--end::usuario_nombre-->
                                </div>
                                ...
                                <div class="fv-row mb-8">    
                                    <!--begin::Password-->
                                    <input type="password" placeholder="Contraseña" name="usuario_contrasenia" autocomplete="off" class="form-control bg-transparent"/>
                                    <!--end::Password-->
                                </div>
                                <!--end::Input group--->
        ...
        <script src="<?= base_url('assets/js/custom/authentication/general.js') ?>"></script>
